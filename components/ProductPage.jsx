...
function ProductDetails({product}) {
  ...
  return (
    <div className=' max-w-7xl mx-auto'>
        <Header/>
        <div>
          <h3 className='mt-3 mx-2'>{product[0].name}</h3>
          <div className='md:flex  mt-5 mx-2 '>
              ...
              <div className=' max-w-2xl  mt-5  mx-5'>
                ...
                <QuillNoSSRWrapper  theme="bubble" value={product[0].description} readOnly />
                <h6 className=' font-bold text-2xl ml-4'>£{product[0].price}</h6>
        ...
        <div className=' max-w-2xl  mt-5 border-t-2 border-gray-300 mx-5'>
          ...
          {Object.entries(product[0].properties).map(([key, value]) => (
